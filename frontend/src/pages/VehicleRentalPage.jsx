...
const VehicleRentalPage = () => {
  ...
  return (
    <div className="rental-details">
      ...
      <p><strong>Category:</strong> {vehicleRental.category}</p>
      <p><strong>Description:</strong> {vehicleRental.description}</p>
      <p><strong>Agency:</strong> {vehicleRental.agency?.name}</p>
      <p><strong>Agency Email:</strong> {vehicleRental.agency?.contactEmail}</p>
      <p><strong>Fleet Size:</strong> {vehicleRental.agency?.fleetSize ?? "N/A"}</p>
      <p>
        <strong>Location:</strong> {vehicleRental.location?.city},{" "}
        {vehicleRental.location?.state}
      </p>
      <p><strong>Daily Price:</strong> ${vehicleRental.dailyPrice}</p>
      <p><strong>Status:</strong> {vehicleRental.availabilityStatus}</p>
      <p>
      ...
      <p><strong>Insurance Policy:</strong> {vehicleRental.insurancePolicy}</p>
